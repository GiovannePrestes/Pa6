#pragma checksum "C:\Users\Giovanne Prestes\Desktop\Pa6\ControlePatrimonios\ControlePatrimonios\Views\Estado\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4cc4a2b54b140d86c6af7717e5ffc34dbd05b26b"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4cc4a2b54b140d86c6af7717e5ffc34dbd05b26b", @"/Views/Estado/Index.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "4cc4a2b54b140d86c6af7717e5ffc34dbd05b26b5502", async() => {
...
#line 49 "C:\Users\Giovanne Prestes\Desktop\Pa6\ControlePatrimonios\ControlePatrimonios\Views\Estado\Index.cshtml"
...
#line 55 "C:\Users\Giovanne Prestes\Desktop\Pa6\ControlePatrimonios\ControlePatrimonios\Views\Estado\Index.cshtml"
          Write(Url.Action("Details", "Estado"));

#line default
#line hidden
            EndContext();
            BeginContext(2033, 421, true);
            WriteLiteral(@""",
            {
                id: EstadoId
            })
...
#line hidden
            ...
            .done(function (resultNomeEstado) {
                swal({
                    title: ""Tem certeza?"",
                    text: ""Você irá excluir o Estado: '"" + resultNomeEstado.message + ""'"",
                    icon: ""warning"",
                    buttons: true,
                    dangerMode: true
                })
            ...
            WriteLiteral(@""",
                                ...
                                .done(function (result) {
                                    if (result.success) {
                                        ...
                                        swal({
                                            title: ""Atenção!"",
                                            text: ""Não foi possível excluir o Estado '"" + result.message + ""' pois existem objetos atrelados a ele"",
                                            icon: ""warning""
                      ");
            WriteLiteral(@"                  });
                                    }
