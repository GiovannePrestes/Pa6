#pragma checksum "C:\Users\Giovanne Prestes\Desktop\Pa6\ControlePatrimonios\ControlePatrimonios\Views\Estado\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f371131e1f1f9eb836db775c02034cbab4c43111"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f371131e1f1f9eb836db775c02034cbab4c43111", @"/Views/Estado/Index.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "f371131e1f1f9eb836db775c02034cbab4c431115502", async() => {
                            ...
                            $.post(""./Estado/Delete"",
                                ...
                                .done(function (result) {
                                    if (result.success) {
                                        ...
                                        swal({
                                            title: ""Atenção!"",
                                            text: ""O Estado '"" + result.");
            WriteLiteral(@"message + ""' tem objetos atrelados a ele, ao confirmar todos os objetos serão excluidos, deseja excluir mesmo assim?"",
                                            icon: ""warning"",
                                            buttons: true,
                                            dangerMode: true,
                                                ...
                                                $.post(""./Estado/DeleteConfirmed"",
                                                    ...
                                                    .done(function (result) {
                                                        if (result.success) {
                                                            swal({
                                                                text: ""Estado '"" + r");
            WriteLiteral(@"esult.message + ""' deletado com sucesso"",
                                                                icon: ""success""
                                                            }).then(() => {
                                                                window.location.reload();
                                                            });
